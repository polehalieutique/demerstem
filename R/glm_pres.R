...
glm_pres <- function(tab, parametres, interactions){
  ...
  if(interactions=="auto"){
    ...
    }else{print("les interactions ordre 2 ne sont pas testees car le nombre de donnees ou de parametres est trop important")}
